...
st.title("🛍️ FeelCart: Shop What You Feel")
st.caption("A smart assistant that understands your mood and shopping needs - in real time.")
...
# --- TABS ---
tabs = st.tabs(["🧠 MoodCart", "🔎 AutoCart"])

# --- MoodCart Tab ---
with tabs[0]:
    st.header("🧠 MoodCart: Shop by Mood")
...
# --- AutoCart Tab ---
with tabs[1]:
    st.header("🔎 AutoCart Smart Shopping Assistant")
